...
const customWebpackConfig = (config, merge, appDir, isDev) => {
	const newConfig = { ...config };

	/**
	 * Start with SVG Options
	 */
	 const svgoLoader = {
		loader: 'svgo-loader',
		options: {
	...
	return merge(newConfig, configWithSvgAndFonts);
...
module.exports = {
	// Project Identity
	appName: 'derweiliStarterTheme', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'derweili-starter-theme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'derweiliStarterTheme',
		...
		// If this has length === 1, then single compiler
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				...
				main: ['./src/assets/js/app.js'], // Or an array of string (string[])
				editor: ['./src/assets/js/editor.js'], // Or an array of string (string[])
			},
